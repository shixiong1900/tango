...
def populate():
    ...
    # Then we will create a dictionary of dictionaries for our categorys.
    # This might seems a little bit confusing, but it allows us to iterate
    # through eath date structure, and add the data to our models.
    ...
    django_pages = [
        {"title": "Official Django Tutorial",
         "url"  : "http://docs.djangoproject.com/en/1.9/intro/tutorial01/",'views':32},
        {"title": "Django Rocks",
    ...
    other_pages = [
        {"title":"Bottle",
         "url"  :"http://botlepy.org/docs/dev",'views':32},
        {"title":"Flask",
